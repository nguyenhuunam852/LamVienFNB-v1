...
<body class="main-layout">
    ...
    <script>
        ...
        function animateOnScroll() {
            ...
            document.querySelectorAll('.palne-img-area .hidden, .palne-img-area .visible').forEach(function(element) {
            ...
            document.querySelectorAll('.section-2 .hidden, .section-2 .visible').forEach(function(element, index) {
                let elementTop = element.getBoundingClientRect().top + window.scrollY;
                let elementBottom = elementTop + element.offsetHeight;
            ...
            document.querySelectorAll('.section-3 .hidden, .section-3 .visible').forEach(function(element, index) {
                let elementTop = element.getBoundingClientRect().top + window.scrollY;
                let elementBottom = elementTop + element.offsetHeight;
